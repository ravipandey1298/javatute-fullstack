...
public class TestParametereised {
	public static void main(String[] args) {
		
	Customer c = new Customer("manohar", "Delhi", 343434);
	
	System.out.println(c.customerName);
	System.out.println(c.address);
	System.out.println(c.contactNumber);
	System.out.println(c.customerId);
	Customer c1 = new Customer("manohar", "Delhi", 343434);
	...
	Customer c2 = new Customer("manohar", "Delhi", 343434);
